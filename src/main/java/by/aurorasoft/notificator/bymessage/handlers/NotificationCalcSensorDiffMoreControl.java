...
public class NotificationCalcSensorDiffMoreControl extends NotificationCalcSensorDiffAbstractControl {
    public NotificationCalcSensorDiffMoreControl(Meta meta, boolean isContinuable, Sensor sensor, double diff) {
