...
@Getter
public class NotificationCalcLowBattery extends NotificationCalcSensor {

    private final double min;

    public NotificationCalcLowBattery(Meta meta, boolean isContinuable, Sensor sensor, double min) {
