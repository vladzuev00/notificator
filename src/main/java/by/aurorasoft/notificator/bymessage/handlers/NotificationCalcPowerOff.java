...
@Getter
public class NotificationCalcPowerOff extends NotificationCalcSensor {

    private final double min;

    public NotificationCalcPowerOff(Meta meta, boolean isContinuable, Sensor sensor, double min) {
